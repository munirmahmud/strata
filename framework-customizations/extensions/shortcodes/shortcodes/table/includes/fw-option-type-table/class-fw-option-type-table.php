...
class Wellnesscenter_Option_Type_Table extends FW_Option_Type
{
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		wp_enqueue_script(
			...
			'msgEdit' => esc_html__( 'Edit', 'strata' ),
	...
	protected function _render( $id, $option, $data ) {
		...
		if ( ! $table_shortcode ) {
			trigger_error(
				__( 'table-builder option type must be inside the table shortcode', 'strata' ),
				E_USER_ERROR
			);
		}
	...
	protected function _get_defaults() {
		return array(
			'header_options'  => array(
				'table_purpose' => array(
					'type'    => 'select',
					'label'   => esc_html__( 'Table Styling', 'strata' ),
					'desc'    => esc_html__( 'Choose the table styling options', 'strata' ),
					'choices' => array(
						'pricing' => esc_html__( 'Use the table as a pricing table', 'strata' ),
						'tabular' => esc_html__( 'Use the table to display tabular data', 'strata' ),
					),
					'value'   => 'pricing',
					'attr'    => array(
			...
			'row_options'     => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-row' => esc_html__( 'Default row', 'strata' ),
						'heading-row' => esc_html__( 'Heading row', 'strata' ),
						'pricing-row' => esc_html__( 'Pricing row', 'strata' ),
						'button-row'  => esc_html__( 'Button row', 'strata' ),
						'switch-row'  => esc_html__( 'Modal button row', 'strata' )
					),
				)
			),
			'columns_options' => array(
				'name' => array(
					...
					'desc'    => false,
					'choices' => array(
						'default-col'   => esc_html__( 'Default column', 'strata' ),
						'highlight-col' => esc_html__( 'Highlight column', 'strata' ),
					),
				)
			),
			'content_options' => array(
				...
				'heading-row' => array(
					'heading' => array(
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => esc_html__('title', 'strata')
						),
					),
					'sub_heading' => array(
						'type'  => 'text',
						...
						'desc'  => false,
						'attr' => array(
							'placeholder' => esc_html__('sub title (can be left blank)', 'strata')
						),
					),
				),
				'pricing-row' => array(
					'amount' => array(
						...
						'value' => '',
						'attr' => array(
							'placeholder' => esc_html__('199', 'strata')
						),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-12'
						)
					...
					'description' => array(
						...
						'value'        => '',
						'attr' => array(
							'placeholder' => esc_html__('per day', 'strata')
						),
						'wrapper_attr' => array(
							'class' => 'fw-col-sm-6'
						)
				...
				'button-row'  => array(
					'button' => ($button = fw()->extensions->get( 'shortcodes' )->get_shortcode( 'button' ))
						? array(
							'type'          => 'popup',
							'popup-title'   => esc_html__( 'Button', 'strata' ),
							'button'        => esc_html__( 'Add', 'strata' ),
