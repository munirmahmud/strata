...
<div class="fw-alert fw-alert-<?php echo esc_attr($atts['type']); ?>">
    ...
    switch ($atts['type']) {
        case 'success' :
            ...
            echo '<strong>' . esc_html__('Congratulations!', 'strata') . '</strong> ';
            break;
        case 'info' :
            echo '<i class="fa fa-exclamation-circle alert-icon"></i>';
            echo '<strong>' . esc_html__('Information!', 'strata') . '</strong> ';
            break;
        case 'warning' :
            echo '<i class="fa fa-warning alert-icon"></i>';
            echo '<strong>' . esc_html__('Alert!', 'strata') . '</strong> ';
            break;
        case 'danger' :
            echo '<i class="fa fa-times-circle alert-icon"></i>';
            echo '<strong>' . esc_html__('Error!', 'strata') . '</strong> ';
            break;
    }
