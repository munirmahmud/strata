...
<?php if ( isset( $data[ 'slides' ] ) ): ?>
	...
	<div id="main-slide" class="carousel slide" data-ride="carousel">
						...
						<div class="slider-content <?php echo isset($slide['extra']['slider_align']) ? $slide['extra']['slider_align'] : 'text-left'; ?>">
							<div class="col-md-12">
								...
								<?php if ( $slide[ 'extra' ][ 'slider_subtitle' ] != '' ): ?>
									<h3 class="slide-sub-title animated3"><?php echo themespry_kses( $slide[ 'extra' ][ 'slider_subtitle' ] ); ?></h3>
								<?php endif; if ( $slide[ 'extra' ][ 'slider_desc' ] != '' ): ?>
								<p class="slider-description lead animated3"><?php echo themespry_kses( $slide[ 'extra' ][ 'slider_desc' ] ); ?></p>
										<?php endif; ?>
								<p class="animated3">
									<?php
									foreach ( $slide[ 'extra' ][ 'button_settings' ] as $btn ):
										...
										?>
										<a target="<?php echo esc_html( $btn[ 'target' ] ); ?>" href="<?php echo esc_url( $btn[ 'link' ] ); ?>" class="slider <?php themespry_theme_button_class( $btn[ 'style' ] ); ?>"> <?php echo wp_kses( $icon, themespry_allowed_html() ); ?> <?php echo wp_kses_post( $btn[ 'label' ] ); ?></a>
									<?php endforeach; ?>
		...
		<ol class="carousel-indicators">
			<?php echo wp_kses( $indicators, themespry_allowed_html() ); ?>
		</ol>
