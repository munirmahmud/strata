...
class TP_Faq_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
			'xs_faq',
			[
				'label' => esc_html__( 'Accordion Items', 'strata' ),
				'type' => Controls_Manager::REPEATER,
				'default' => [
					[
						'tab_title' => esc_html__( 'Accordion #1', 'strata' ),
						'tab_content' => esc_html__( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strata' ),
					],
					[
						'tab_title' => esc_html__( 'Accordion #2', 'strata' ),
						'tab_content' => esc_html__( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'strata' ),
					],
				],
				'fields' => [
					[
						...
						'default' => esc_html__( 'Accordion Title' , 'strata' ),
						'label_block' => true,
					],
					[
						'name' => 'tab_content',
						...
						'default' => esc_html__( 'Accordion Content', 'strata' ),
						'label_block' => true,
					],
				],
        ...
        $this->start_controls_section(
			'section_title_style',
			[
				'label' => esc_html__( 'Accordion', 'strata' ),
		...
		$this->add_control(
			'border_width',
			[
				'label' => esc_html__( 'Border Width', 'strata' ),
		...
		$this->add_control(
			'border_color',
			[
				'label' => esc_html__( 'Border Color', 'strata' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Background Color', 'strata' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Icon Active Background Color', 'strata' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Active Background Color', 'strata' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'tab_active_color',
			[
				'label' => esc_html__( 'Active Color', 'strata' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
...
<div id="accordion" role="tablist">
    ...
    <?php if(is_array($xs_faq) && !empty($xs_faq)): ?>
        ...
        foreach($xs_faq as $key => $faq):
            $tabs_id = uniqid('tp-faq-').mt_rand(1000,9999);
            ?>
