...
class Strata_Theme_Includes {
	...
	public static function init() {
        ...
        if ( class_exists( 'TpCustomPost\TP_CustomPost' ) ) {
             ...
             * $tab_tax = new TpCustomPost\TP_Taxonomies( 'strata' );
             * $tab_tax->tp_post_init( 'service_cat', 'Service Category', 'Categories', 'service' );
             */
            $tab = new TpCustomPost\TP_CustomPost( 'strata' );
            ...
            $portfolio_tax = new  TpCustomPost\TP_Taxonomies('strata');
	...
	public static function _action_enqueue_scripts() {
		self::include_child_first( '/theme-file.php' );
	}
	...
	public static function _action_widgets_init() { {
		...
		foreach ( $paths as $path ) {
			...
			foreach ( $dirs as $dir ) {
				...
				register_widget( 'Strata_' . self::dirname_to_classname( $dirname ) );
			}
		}
	}
