...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( STRATA_INC . '/includes/option-types/new-icon/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'strata' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'strata' ),
					'hand'				 => esc_html__( 'Hand Icons', 'strata' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'strata' ),
					'gender'			 => esc_html__( 'Gender Icons', 'strata' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'strata' ),
					'payment'			 => esc_html__( 'Payment Icons', 'strata' ),
					'currency'			 => esc_html__( 'Currency Icons', 'strata' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'strata' ),
					'directional'		 => esc_html__( 'Directional Icons', 'strata' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'strata' ),
					'brand'				 => esc_html__( 'Brand Icons', 'strata' ),
					'medical'			 => esc_html__( 'Medical Icons', 'strata' ),
					'finences-icons'	 => esc_html__( 'Finences Icons', 'strata' ),
				),
				'icons'				 => array(
